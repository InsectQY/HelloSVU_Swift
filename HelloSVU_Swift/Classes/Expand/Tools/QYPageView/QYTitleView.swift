...
extension QYTitleView: QYContentViewDelegate {
    ...
    func contentView(_ contentView: QYContentView, targetIndex: Int, progress: CGFloat) {
        ...
        oldLabel.textColor = UIColor(red: (selectRGB.0 - deltaRGB.0 * progress) / 255.0, green: (selectRGB.1 - deltaRGB.1 * progress) / 255.0, blue: (selectRGB.2 - deltaRGB.2 * progress) / 255.0, alpha: 1)
        newLabel.textColor = UIColor(red: (normalRGB.0 + deltaRGB.0 * progress) / 255.0, green: (normalRGB.1 + deltaRGB.1 * progress) / 255.0, blue: (normalRGB.2 + deltaRGB.2 * progress) / 255.0, alpha: 1)
